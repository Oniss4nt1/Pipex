...
MU_TEST(test_list_and_count_number_of_lines)
{
	run_command("../pipex ../infile \"cat\" \"tr a-z A-Z\" ../outfile_result");
    run_command("< ../infile cat | tr 'a-z' 'A-Z' > ../outfile_expected");
...
{
	MU_RUN_TEST(test_list_and_count_number_of_lines);
}
